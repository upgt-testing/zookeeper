 ...
 * snapshot.
 */
public class InvalidSnapshotTest_RestartInjected extends ClientBase {

    private static final Logger LOG = LoggerFactory.getLogger(InvalidSnapshotTest_RestartInjected.class);

    public InvalidSnapshotTest_RestartInjected() {
    ...
    public void testInvalidSnapshot() throws Exception {
        ...
        RestartFramework.at("after_stop_server")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_corrupt_snapshot")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_restart_server")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
