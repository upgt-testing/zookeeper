...
public class SnapshotDigestTest_RestartInjected_Randomized_123 extends ClientBase {

    private static final Logger LOG = LoggerFactory.getLogger(SnapshotDigestTest_RestartInjected.class);
    ...
    public void testSnapshotDigest() throws Exception {
        ...
        RestartFramework.at("after_multi_op").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        zk.multi(subTxns);
        RestartFramework.at("after_delete").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        reloadSnapshotAndCheckDigest();
    ...
    private void testCompatibleHelper(Boolean enabledBefore, Boolean enabledAfter) throws Exception {
        ...
        reloadSnapshotAndCheckDigest();
        RestartFramework.at("after_create_compatible_node").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
