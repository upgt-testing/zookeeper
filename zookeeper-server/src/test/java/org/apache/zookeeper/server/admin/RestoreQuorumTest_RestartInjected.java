...
public class RestoreQuorumTest_RestartInjected extends QuorumPeerTestBase {
    @Test
    public void testRestoreAfterQuorumLost() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_initial_data_creation")
                .on(servers.mt[1])
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_additional_data_creation")
                .on(servers.mt[0])
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_quorum_restored")
                .on(servers.mt[1])
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_restore_complete")
                .on(servers.mt[2])
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_post_restore_data")
                .on(servers.mt[0])
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
