...
public class Emulate353TTLTest_RestartInjected extends ClientBase {
    ...
    public void testCreate() throws KeeperException, InterruptedException {
        ...
        RestartFramework.at("after_first_container_check")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void test353TTL() throws KeeperException, InterruptedException {
        ...
        RestartFramework.at("after_create_353_ttl_node")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_first_353_container_check")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_353_ttl_expiration")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testEphemeralOwner_emulationTTL() {
        ...
        RestartFramework.at("after_emulation_ttl_check")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testEphemeralOwner_emulationContainer() {
        ...
        RestartFramework.at("after_emulation_container_check")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
