 ...
 * ZooKeeper
 */
public class RaceConditionTest_RestartInjected extends QuorumPeerTestBase {
    ...
    public void testRaceConditionBetweenLeaderAndAckRequestProcessor() throws Exception {
        ...
        RestartFramework.at("after_wait_leader_state_change")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_old_leader_up")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
