...
public class CurrentEpochWriteFailureTest_RestartInjected extends QuorumPeerTestBase {
    ...
    public void testReadCurrentEpochFromAcceptedEpochTmpFile() throws Exception {
        startServers();
        RestartFramework.at("after_start_servers")
            .on(servers.mt[0])
            .restart("server")
            .withIndex(0)
        ...
        restartServers();
        RestartFramework.at("after_restart_servers")
            .on(servers.mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_get_current_epoch")
            .on(servers.mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_shutdown_servers")
            .on(servers.mt[1])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_create_file_scenario")
            .on(servers.mt[2])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_restart_all_servers")
            .on(servers.mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
