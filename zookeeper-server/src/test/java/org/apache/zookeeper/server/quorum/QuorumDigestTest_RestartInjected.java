...
public class QuorumDigestTest_RestartInjected extends QuorumPeerTestBase {
    ...
    public void testDigestMatchesDuringDiffSync() throws Exception {
        ...
        RestartFramework.at("after_diff_sync")
            .on(servers.mt[0])
            .restart("server")
            .withIndex(0)
    ...
    public void testDigestMatchesDuringSnapSync() throws Exception {
        ...
        RestartFramework.at("after_trigger_sync")
            .on(servers.mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_extra_operations")
    ...
    public void testDigestMatchesWithAsyncRequests() throws Exception {
        ...
        RestartFramework.at("after_follower_observer_restart")
            .on(servers.mt[servers.findAnyFollower()])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
            .execute();
    ...
    public void testDigestMismatchesWhenTxnLost() throws Exception {
        ...
        RestartFramework.at("after_initial_ops")
            .on(servers.mt[leader])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_servers_restart_with_fault")
            .on(servers.mt[servers.findAnyFollower()])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_additional_ops")
            .on(servers.mt[leader])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
