...
public class GetAllChildrenNumberTest_RestartInjected extends ClientBase {
    ...
    public void testGetAllChildrenNumberSync() throws KeeperException, InterruptedException {
        ...
        RestartFramework.at("after_multiple_queries")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testGetAllChildrenNumberAsync() throws IOException, KeeperException, InterruptedException {
        ...
        RestartFramework.at("after_async_call")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
