...
public class ZKUtilTest_RestartInjected extends ClientBase {
    ...
    public void testValidateFileInput() throws IOException {
        RestartFramework.at("before_file_validation")
            .on(this)
            .restart("server")
            .withIndex(0)
    ...
    public void testDeleteRecursiveInAsyncMode() throws Exception {
        RestartFramework.at("before_async_delete_test")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testDeleteRecursiveInSyncMode() throws Exception {
        RestartFramework.at("before_sync_delete_test")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
