 ...
 */
public class RemoveWatchesCmdTest_RestartInjected_Randomized_123 extends ClientBase {

    private static final Logger LOG = LoggerFactory.getLogger(RemoveWatchesCmdTest_RestartInjected.class);
    ...
    public void testRemoveWatchesWithNoPassedOptions() throws Exception {
        ...
        RestartFramework.at("after_remove_watchers").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_add_watchers").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRemoveNodeDataChangedWatches() throws Exception {
        ...
        RestartFramework.at("after_add_data_watcher").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_remove_watcher").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        zk.create("/testnode1", "data".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
        zk.getData("/testnode1", myWatcher, null);
    ...
    public void testRemoveNodeCreatedWatches() throws Exception {
        ...
        RestartFramework.at("after_first_remove").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_add_exists_watchers").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_second_remove").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRemoveNodeChildrenChangedWatches() throws Exception {
        ...
        myWatcher.matches();
        RestartFramework.at("after_remove_watcher").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_add_child_watcher").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRemoveNodeDeletedWatches() throws Exception {
        ...
        RestartFramework.at("after_add_child_watchers").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        zk.create("/testnode1", "data".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
