...
public class PersistentWatcherTest_RestartInjected extends ClientBase {
    ...
    public void testMultiClient()
        ...
        try (ZooKeeper zk1 = createClient(new CountdownWatcher(), hostPort);
            ...
            RestartFramework.at("after_first_set_data")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testRootWatcher()
        ...
        try (ZooKeeper zk = createClient(new CountdownWatcher(), hostPort)) {
            ...
            zk.create("/a", new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
            RestartFramework.at("after_create_node_a")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_create_node_b")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
