...
public class SaslDigestAuthOverSSLTest_RestartInjected_Randomized_123 extends SaslAuthDigestTestBase {
    ...
    public void testAuth() throws Exception {
        ...
        try {
            ...
            Thread.sleep(1000);
            RestartFramework.at("after_sleep").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
