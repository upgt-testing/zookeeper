...
public class ThrottledOpStandaloneTest_RestartInjected extends ClientBase {
    ...
    public void testThrottledOp() throws IOException, InterruptedException, KeeperException {
        ...
        try {
            ...
            RestartFramework.at("before_throttled_op_test")
                .on(this)
                .restart("server")
                .withIndex(0)
            ...
            RestartFramework.at("after_throttled_op_test")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testThrottledAcl() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("before_throttled_acl_test")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_throttled_acl_test")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
