...
public class FourLetterWordsWhiteListTest_RestartInjected_Randomized_123 extends ClientBase {
    ...
    public void testFourLetterWordsAllDisabledByDefault() throws Exception {
        ...
        RestartFramework.at("after_final_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_client_close").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        verifyAllCommandsFail();
        zk.getData("/", true, null);
        RestartFramework.at("after_second_command_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_first_command_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        verifyAllCommandsFail();
        RestartFramework.at("after_third_command_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_client_create").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testFourLetterWordsEnableSomeCommands() throws Exception {
        ...
        RestartFramework.at("after_blocked_commands_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_whitelisted_commands_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testISROEnabledWhenReadOnlyModeEnabled() throws Exception {
        ...
        RestartFramework.at("after_server_restart").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        System.setProperty("zookeeper.4lw.commands.whitelist", "stat");
        RestartFramework.at("after_isro_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testFourLetterWordsInvalidConfiguration() throws Exception {
        ...
        verifyAllCommandsFail();
        RestartFramework.at("after_invalid_commands_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // But still, what's valid in white list will get through.
        verifyFuzzyMatch("stat", "Outstanding");
        RestartFramework.at("after_stat_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    public void testFourLetterWordsEnableAllCommandsThroughAsterisk() throws Exception {
        ...
        RestartFramework.at("after_all_commands_verification").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        startServer();
