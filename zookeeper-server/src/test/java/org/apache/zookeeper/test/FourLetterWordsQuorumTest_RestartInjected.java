...
public class FourLetterWordsQuorumTest_RestartInjected extends QuorumBase {
    ...
    public void testFourLetterWords() throws Exception {
        ...
        for (String hp : servers) {
            ...
            verify(hp, "wchp", "");
            verify(hp, "wchc", "");
            RestartFramework.at("after_initial_verifications")
                .on(this)
                .restart("leader")
                .withIndex(0)
            ...
            verify(hp, "wchc", sid);
            verify(hp, "dirs", "size");
            RestartFramework.at("after_watch_verifications")
                .on(this)
                .restart("follower")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_final_verifications")
                .on(this)
                .restart("follower")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
