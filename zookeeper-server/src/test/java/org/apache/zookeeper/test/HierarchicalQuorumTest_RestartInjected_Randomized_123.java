...
public class HierarchicalQuorumTest_RestartInjected_Randomized_123 extends ClientBase {
    ...
    public void setUp() throws Exception {
        ...
        hostPort = "127.0.0.1:" + clientport1 + ",127.0.0.1:" + clientport2 + ",127.0.0.1:" + clientport3 + ",127.0.0.1:" + clientport4 + ",127.0.0.1:" + clientport5;
    ...
    public void testHierarchicalQuorum() throws Throwable {
        cht.runHammer(5, 10);
        RestartFramework.at("before_hammer_test").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_hammer_test").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
}
