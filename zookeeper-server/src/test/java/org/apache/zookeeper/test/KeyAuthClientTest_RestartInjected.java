...
public class KeyAuthClientTest_RestartInjected extends ClientBase {
    ...
    public void testAuth() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_pre_auth_setup")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_missing_auth_test")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        try {
            ...
            RestartFramework.at("after_valid_auth_test")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
        ...
        try {
            ...
            RestartFramework.at("after_valid_auth2_test")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
