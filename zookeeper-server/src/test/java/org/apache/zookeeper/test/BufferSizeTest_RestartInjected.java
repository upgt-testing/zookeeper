...
public class BufferSizeTest_RestartInjected extends ClientBase {
    ...
    private void testRequests(ClientOp clientOp) throws Exception {
        ...
        RestartFramework.at("after_small_request")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_equal_request")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_large_request")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testStartup() throws Exception {
        ...
        RestartFramework.at("after_start_server")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    private void testStartupFailure(File testDir, String failureMsg) throws Exception {
        ...
        RestartFramework.at("after_test_failure_attempt")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
