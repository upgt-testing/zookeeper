...
public class MultiAsyncTransactionTest_RestartInjected_Randomized_456 extends ClientBase {
    ...
    public void testSequentialNodeCreateInAsyncMulti() throws Exception {
        ...
        RestartFramework.at("after_submit_multi_ops").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_verify_second_ops").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_wait_for_ops").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_verify_first_ops").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_verify_return_codes").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
