...
public class SyncCallTest_RestartInjected extends ClientBase implements ChildrenCallback, Children2Callback, StringCallback, VoidCallback, Create2Callback {
    ...
    public void testSync() throws Exception {
        try {
            ...
            RestartFramework.at("after_first_batch_creates")
                .on(this)
                .restart("server")
                .withIndex(0)
            ...
            RestartFramework.at("after_second_batch_creates")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_first_batch_get_children")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
