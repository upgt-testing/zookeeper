...
public class ObserverTest_RestartInjected extends QuorumPeerTestBase implements Watcher {
    ...
    public void testObserverOnly() throws Exception {
        ...
        q1.start();
        RestartFramework.at("after_observer_only_start")
            .on(q1)
            .restart("server")
            .withIndex(0)
    ...
    public void testObserverWithStandlone() throws Exception {
        ...
        MainThread q1 = new MainThread(1, CLIENT_PORT_QP1, quorumCfgSection);
        q1.start();
        RestartFramework.at("after_observer_standalone_start")
            .on(q1)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
