...
public class DisconnectedWatcherTest_RestartInjected_Randomized_123 extends ClientBase {

    protected static final Logger LOG = LoggerFactory.getLogger(DisconnectedWatcherTest_RestartInjected.class);
    ...
    public void testChildWatcherAutoResetWithChroot() throws Exception {
        ...
        RestartFramework.at("after_set_second_watch").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_reconnect").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // this should trigger the watch
        zk1.create("/ch1/youshouldmatter1", null, Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
        RestartFramework.at("after_first_watch_trigger").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        WatchedEvent e = watcher2.events.poll(TIMEOUT, TimeUnit.MILLISECONDS);
        assertNotNull(e);
        RestartFramework.at("after_create_first_child").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_create_second_child").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        startServer();
    ...
    public void testDefaultWatcherAutoResetWithChroot() throws Exception {
        ...
        // this should trigger the watch
        zk1.create("/ch1/youshouldmatter2", null, Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
        RestartFramework.at("after_set_default_watch").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDeepChildWatcherAutoResetWithChroot() throws Exception {
        ...
        RestartFramework.at("after_create_node_again").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        watcher2.waitForDisconnected(3000);
        startServer();
        RestartFramework.at("after_create_deep_path").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        watcher2.waitForConnected(3000);
        watcher1.waitForConnected(3000);
        // this should trigger the watch
        ...
        assertNotNull(e);
        assertEquals(EventType.NodeChildrenChanged, e.getType());
        RestartFramework.at("after_create_node_now").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("/are", e.getPath());
    }
    ...
    public void testManyChildWatchersAutoReset() throws Exception {
        ...
        RestartFramework.at("after_create_base_path").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_create_many_nodes").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        MyWatcher childWatcher = new MyWatcher();
        RestartFramework.at("after_trigger_watches").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
