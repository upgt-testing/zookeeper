...
public class SaslSuperUserTest_RestartInjected extends SaslAuthDigestTestBase {
    ...
    public void testSuperIsSuper() throws Exception {
        ...
        RestartFramework.at("after_sasl_super_ops")
            .on(this)
            .restart("server")
            .withIndex(0)
    ...
    public void testOtherSuperIsSuper() throws Exception {
        ...
        try {
            connectAndPerformSuperOps();
            RestartFramework.at("after_other_sasl_super_ops")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
