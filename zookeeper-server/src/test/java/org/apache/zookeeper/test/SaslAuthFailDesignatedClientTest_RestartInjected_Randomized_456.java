...
public class SaslAuthFailDesignatedClientTest_RestartInjected_Randomized_456 extends SaslAuthDigestTestBase {
    ...
    public void testAuth() throws Exception {
        ...
        RestartFramework.at("after_client_connection").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
