...
public class EnsembleAuthTest_RestartInjected extends ClientBase {
    ...
    public void passAuthCSV() throws Exception {
        ...
        RestartFramework.at("after_connect_foo")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_connect_bar")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_connect_baz")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
