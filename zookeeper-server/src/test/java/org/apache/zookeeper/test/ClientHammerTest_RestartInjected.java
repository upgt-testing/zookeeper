...
public class ClientHammerTest_RestartInjected extends ClientBase {
    ...
    public void runHammer(final int threadCount, final int childCount) throws Throwable {
        try {
            ...
            RestartFramework.at("after_start_all_threads")
                .on(this)
                .restart("server")
                .withIndex(0)
            ...
            RestartFramework.at("after_verify_hammer")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testHammerSuper() throws Throwable {
        try {
            ...
            RestartFramework.at("after_create_roots_and_start_threads")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            verifyHammer(start, threads, childCount);
            RestartFramework.at("after_verify_super_hammer")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
