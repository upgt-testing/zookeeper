...
public class AuthTest_RestartInjected extends ClientBase {
    ...
    public void testBadAuthNotifiesWatch() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_add_bad_auth")
                .on(this)
                .restart("server")
                .withIndex(0)
    ...
    public void testBadAuthThenSendOtherCommands() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_add_invalid_auth")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testSuper() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_no_auth_check")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_bad_pass_check")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_super_bad_pass_check")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            zk.getData("/path1", false, null);
            RestartFramework.at("after_super_success")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testSuperACL() throws Exception {
        ...
        try {
            zk.addAuthInfo("digest", "pat:pass".getBytes());
            zk.create("/path1", null, Ids.CREATOR_ALL_ACL, CreateMode.PERSISTENT);
            RestartFramework.at("after_create_with_creator_acl")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            zk.addAuthInfo("digest", "super:test".getBytes());
            zk.getData("/path1", false, null);
            RestartFramework.at("after_super_get_data")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_set_read_acl")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_set_open_acl")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testOrdinaryACL() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_create_path")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_set_auth_acl")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_super_access")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            zk.addAuthInfo("digest", "username1:password1".getBytes());
            zk.getData(path, false, null);
            RestartFramework.at("after_ordinary_user_access")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
