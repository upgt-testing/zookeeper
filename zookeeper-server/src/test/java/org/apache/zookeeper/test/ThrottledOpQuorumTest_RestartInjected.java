...
public class ThrottledOpQuorumTest_RestartInjected extends QuorumBase {
    @BeforeAll
    ...
    public void testThrottledOpLeader() throws IOException, InterruptedException, KeeperException {
        ...
        try {
            ...
            RestartFramework.at("after_create_client_leader")
                .on(this)
                .restart("leader")
                .withIndex(0)
            ...
            RestartFramework.at("after_throttled_op_leader")
                .on(this)
                .restart("leader")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testThrottledAclLeader() throws Exception {
        ...
        try {
            zk = createClient("localhost:" + getLeaderClientPort());
            RestartFramework.at("after_create_client_acl_leader")
                .on(this)
                .restart("leader")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_throttled_acl_leader")
                .on(this)
                .restart("leader")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testThrottledOpFollower() throws IOException, InterruptedException, KeeperException {
        ...
        try {
            ...
            RestartFramework.at("after_create_client_follower")
                .on(this)
                .restart("follower")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            ThrottledOpHelper test = new ThrottledOpHelper();
            test.testThrottledOp(zk, zs);
            RestartFramework.at("after_throttled_op_follower")
                .on(this)
                .restart("follower")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testThrottledAclFollower() throws Exception {
        ...
        try {
            int clientPort = (getLeaderClientPort() == portClient1) ? portClient2 : portClient1;
            zk = createClient("localhost:" + clientPort);
            RestartFramework.at("after_create_client_acl_follower")
                .on(this)
                .restart("follower")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            ThrottledOpHelper test = new ThrottledOpHelper();
            test.testThrottledAcl(zk, zs);
            RestartFramework.at("after_throttled_acl_follower")
                .on(this)
                .restart("follower")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
