...
public class SaslAuthRequiredTest_RestartInjected extends SaslAuthDigestTestBase {
    ...
    public void testClientOpWithValidSASLAuth() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_sasl_client_create")
                .on(this)
                .restart("server")
                .withIndex(0)
            ...
            RestartFramework.at("after_create_with_sasl_acl")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
