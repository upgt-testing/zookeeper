...
public class SessionInvalidationTest_RestartInjected extends ClientBase {
    ...
    public void testCreateAfterCloseShouldFail() throws Exception {
        ...
        RestartFramework.at("after_socket_operations")
            .on(this)
            .restart("server")
            .withIndex(0)
        ...
        RestartFramework.at("after_verify_children")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
