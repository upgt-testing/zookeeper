 ...
 */
public class EnforceQuotaTest_RestartInjected_Randomized_123 extends ClientBase {
    ...
    public void testSetQuotaDisableWhenExceedCountHardQuota() throws Exception {
        ...
        SetQuotaCommand.createQuota(zk, path, st);
        RestartFramework.at("after_create_c2").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        try {
            ...
            RestartFramework.at("after_create_c3").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ZooKeeperQuotaTest.validateNoQuotaExceededMetrics(namespace);
        } catch (KeeperException.QuotaExceededException e) {
