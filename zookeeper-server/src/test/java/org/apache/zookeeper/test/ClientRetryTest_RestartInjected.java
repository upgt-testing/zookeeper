...
public class ClientRetryTest_RestartInjected extends ClientBase {
    ...
    public void testClientRetry() throws IOException, InterruptedException, TimeoutException {
        ...
        try {
            ...
            RestartFramework.at("after_first_client_connected")
                .on(this)
                .restart("server")
                .withIndex(0)
            ...
            try {
                ...
                RestartFramework.at("after_state_verification")
                    .on(this)
                    .restart("server")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_first_client_disconnected")
                    .on(this)
                    .restart("server")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_second_client_connected")
                    .on(this)
                    .restart("server")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
