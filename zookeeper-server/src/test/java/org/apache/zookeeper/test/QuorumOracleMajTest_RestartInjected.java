...
public class QuorumOracleMajTest_RestartInjected extends QuorumBaseOracle_2Nodes {
    ...
    public void testMajQuorums() throws Throwable {
        ...
        RestartFramework.at("after_jmx_verification")
            .on(this)
            .restart("leader")
            .withIndex(0)
        ...
        RestartFramework.at("after_no_drop_connection_test")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_drop_connection_test")
            .on(this)
            .restart("server")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
