...
public class PersistentRecursiveWatcherTest_RestartInjected extends ClientBase {
    ...
    public void testBasic()
        ...
        try (ZooKeeper zk = createClient(new CountdownWatcher(), hostPort)) {
            ...
            RestartFramework.at("after_add_watch")
                .on(this)
                .restart("server")
                .withIndex(0)
    ...
    public void testBasicAsync()
        ...
        try (ZooKeeper zk = createClient(new CountdownWatcher(), hostPort)) {
            ...
            RestartFramework.at("after_add_watch_async")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testRemoval()
        ...
        try (ZooKeeper zk = createClient(new CountdownWatcher(), hostPort)) {
            ...
            RestartFramework.at("after_remove_watches")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testNoChildEvents() throws Exception {
        try (ZooKeeper zk = createClient()) {
            ...
            RestartFramework.at("after_add_root_watch")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testDisconnect() throws Exception {
        try (ZooKeeper zk = createClient(new CountdownWatcher(), hostPort)) {
            ...
            RestartFramework.at("after_add_watch_before_disconnect")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testMultiClient()
        ...
        try (ZooKeeper zk1 = createClient(new CountdownWatcher(), hostPort); ZooKeeper zk2 = createClient(new CountdownWatcher(), hostPort)) {
            ...
            RestartFramework.at("after_add_watch_multi_client")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testSamePathWithDifferentWatchModes() throws Exception {
        try (ZooKeeper zk = createClient()) {
            ...
            RestartFramework.at("after_add_multiple_watches")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testRootWatcher()
        ...
        try (ZooKeeper zk = createClient(new CountdownWatcher(), hostPort)) {
            ...
            RestartFramework.at("after_add_root_watcher")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
