...
public class QuorumMajorityTest_RestartInjected extends QuorumBase {
    ...
    public void testMajQuorums() throws Throwable {
        ...
        RestartFramework.at("after_initial_election_check")
            .on(this)
            .restart("follower")
            .withIndex(0)
        ...
        RestartFramework.at("after_setup_all_followers")
            .on(this)
            .restart("leader")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_first_quorum_test")
            .on(this)
            .restart("follower")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_setup_with_observers")
            .on(this)
            .restart("leader")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_second_quorum_test")
            .on(this)
            .restart("observer")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
