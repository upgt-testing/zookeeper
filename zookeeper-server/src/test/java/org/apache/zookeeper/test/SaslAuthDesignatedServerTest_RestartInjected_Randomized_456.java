...
public class SaslAuthDesignatedServerTest_RestartInjected_Randomized_456 extends SaslAuthDigestTestBase {
    ...
    public void testAuth() throws Exception {
        ...
        RestartFramework.at("after_sasl_auth_complete").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
