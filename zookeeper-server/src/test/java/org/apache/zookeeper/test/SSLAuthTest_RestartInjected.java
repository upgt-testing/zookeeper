...
public class SSLAuthTest_RestartInjected extends ClientBase {
    ...
    public void testRejection() throws Exception {
        ...
        RestartFramework.at("after_set_untrusted_keystore")
            .on(this)
            .restart("server")
            .withIndex(0)
        ...
        RestartFramework.at("after_untrusted_client_create")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testMisconfiguration() throws Exception {
        ...
        RestartFramework.at("after_misconfigured_client_create")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
