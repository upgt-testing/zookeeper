...
public class MaxCnxnsTest_RestartInjected_Randomized_123 extends ClientBase {
    ...
    public void testMaxCnxns() throws IOException, InterruptedException {
        ...
        RestartFramework.at("after_start_connections").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_connections_complete").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
