...
public class EnsembleAuthTest_RestartInjected_Randomized_123 extends ClientBase {
    ...
    public void passAuthCSV() throws Exception {
        ...
        connectToEnsemble("foo");
        RestartFramework.at("after_connect_foo").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        connectToEnsemble("bar");
        RestartFramework.at("after_connect_bar").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_connect_baz").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
