...
public class CheckTest_RestartInjected extends ClientBase {
    ...
    public void testStandalone() throws Exception {
        ...
        RestartFramework.at("after_test_operations")
            .on(this)
            .restart("server")
            .withIndex(0)
    ...
    public void testCluster() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_observer_test")
                .on(qb)
                .restart("observer")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_follower_test")
                .on(qb)
                .restart("follower")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_leader_test")
                .on(qb)
                .restart("leader")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testClusterDatabaseReloadAfterCheck() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_leader_test_operations")
                .on(qb)
                .restart("leader")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
                .execute();
            qb.shutdown(leader);
            RestartFramework.at("after_leader_shutdown")
                .on(qb)
                .restart("follower")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_database_load")
                .on(qb)
                .restart("follower")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
