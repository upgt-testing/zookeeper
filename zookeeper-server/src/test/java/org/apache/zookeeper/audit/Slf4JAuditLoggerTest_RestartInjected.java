...
public class Slf4JAuditLoggerTest_RestartInjected extends QuorumPeerTestBase {
    ...
    public void testCreateAuditLogs()
        ...
        RestartFramework.at("after_create_audit_node")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
    ...
    public void testCreateWithTtlAuditLogs()
        ...
        RestartFramework.at("after_create_ttl_node")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testCreateSeqWithTtlAuditLogs()
        ...
        path = zk.create(path, "".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE,
                createMode, null, 3600);
        RestartFramework.at("after_create_sequential_ttl_node")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testDeleteAuditLogs()
        ...
        verifyLog(getAuditLog(AuditConstants.OP_DELETE, path,
                ...
                readAuditLog(os));
        zk.delete(path, -1);
        RestartFramework.at("after_delete_audit_node")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSetDataAuditLogs()
        ...
        RestartFramework.at("after_setdata_audit")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSetACLAuditLogs()
        ...
        RestartFramework.at("after_setacl_audit")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testMultiOperationAuditLogs()
        ...
        zk.multi(ops);
        RestartFramework.at("after_multi_operation_audit")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testEphemralZNodeAuditLogs()
        ...
        RestartFramework.at("after_create_ephemeral_audit")
            .on(mt[0])
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
