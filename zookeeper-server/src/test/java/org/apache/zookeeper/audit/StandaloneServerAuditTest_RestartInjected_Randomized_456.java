...
public class StandaloneServerAuditTest_RestartInjected_Randomized_456 extends ClientBase {
    ...
    public void testCreateAuditLog() throws KeeperException, InterruptedException, IOException {
        ...
        RestartFramework.at("after_read_audit_log").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
