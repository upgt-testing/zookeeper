 ...
 */
public class RemoveWatchesCmdTest_RestartInjected extends ClientBase {
    ...
    public void testRemoveWatchesWithNoPassedOptions() throws Exception {
        ...
        RestartFramework.at("after_add_watchers")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_remove_watchers")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testRemoveNodeDataChangedWatches() throws Exception {
        ...
        RestartFramework.at("after_add_data_watcher")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_remove_watcher")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testRemoveNodeCreatedWatches() throws Exception {
        ...
        RestartFramework.at("after_add_exists_watchers")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_first_remove")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_second_remove")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testRemoveNodeChildrenChangedWatches() throws Exception {
        ...
        RestartFramework.at("after_add_child_watcher")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testRemoveNodeDeletedWatches() throws Exception {
        ...
        RestartFramework.at("after_add_child_watchers")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
