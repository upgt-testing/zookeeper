 ...
 */
public class TimeTest_RestartInjected_Randomized_123 extends ClientBase {
    ...
    public void testElapsedTimeToDate() throws Exception {
        ...
        RestartFramework.at("after_time_capture").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Thread.sleep(200);
