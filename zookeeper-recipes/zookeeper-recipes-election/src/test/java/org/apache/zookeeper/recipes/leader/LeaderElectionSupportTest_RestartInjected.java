 ...
 */
public class LeaderElectionSupportTest_RestartInjected extends ClientBase {
    ...
    public void testNode() throws Exception {
        ...
        RestartFramework.at("after_start_election")
            .on(this)
            .restart("server")
            .withIndex(0)
        ...
        RestartFramework.at("before_stop_election")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testNodes3() throws Exception {
        ...
        RestartFramework.at("after_spawn_election_threads")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testOfferShuffle() throws InterruptedException {
        ...
        RestartFramework.at("after_spawn_delayed_threads")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testGetLeaderHostName() throws Exception {
        ...
        RestartFramework.at("after_get_leader_hostname")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testReadyOffer() throws Exception {
        ...
        RestartFramework.at("after_start_first_election")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_start_second_election")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_reelection_complete")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
