 ...
 */
public class DistributedQueueTest_RestartInjected_Randomized_456 extends ClientBase {
    ...
    public void testOffer1() throws Exception {
        ...
        RestartFramework.at("after_queue_offer").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRemove1() throws Exception {
        ...
        RestartFramework.at("after_queue_creation").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void testRemove2() throws Exception {
        String dir = "/testRemove2";
        RestartFramework.at("after_queue_removes").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        int n = 10;
        int m = 2;
        String testString = "Hello World";
        final int numClients = 2;
        ...
        byte[] data = null;
        RestartFramework.at("after_queue_offers").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        for (int i = 0; i < m; i++) {
            data = queueHandles[1].remove();
        }
        assertNotNull(data);
    ...
    public void testTakeWait2() throws Exception {
        ...
        for (int i = 0; i < numAttempts; i++) {
            ...
            offerThread.start();
            offerThread.join();
            RestartFramework.at("after_queue_offer_iteration").on(this).restart("server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            takeThread.join();
            assertNotNull(takeResult[0]);
