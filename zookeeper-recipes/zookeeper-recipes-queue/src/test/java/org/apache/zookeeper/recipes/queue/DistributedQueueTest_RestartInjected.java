 ...
 */
public class DistributedQueueTest_RestartInjected extends ClientBase {
    ...
    public void testOffer1() throws Exception {
        ...
        RestartFramework.at("after_queue_offer")
            .on(this)
            .restart("server")
            .withIndex(0)
    ...
    public void testRemove1() throws Exception {
        ...
        RestartFramework.at("after_queue_creation")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testRemove2() throws Exception {
        ...
        RestartFramework.at("after_queue_offers")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_queue_removes")
            .on(this)
            .restart("server")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testTakeWait2() throws Exception {
        ...
        for (int i = 0; i < numAttempts; i++) {
            ...
            RestartFramework.at("after_queue_offer_iteration")
                .on(this)
                .restart("server")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
